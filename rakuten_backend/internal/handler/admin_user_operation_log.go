...
func AdminUserOperationLogList(c *context.Context) {
	...
	dataRsp, err := service.GetAdminUserOperationLogList(id, username, page, pageSize, operationType, operationIp, startTime, endTime, 0)
	if err != nil {
