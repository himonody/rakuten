...
func GetAdminAgentOperationLogList(id int, username string, page, pageSize, operationType int, operationIp string, startTime, endTime string, isAgent int) (map[string]interface{}, error) {
